...
void testPerformance(Collection* collection) {
    ...
    std::cout << "Time taken to add 50000 random elements: " << elapsedTime.count() << " seconds" << std::endl;
    ...
    std::cout << "Time taken to remove 10000 random elements: " << elapsedTime.count() << " seconds" << std::endl;
...
int main()
{
    Collection* c1 = new IntervalCollection(0, 50000);
